...
public class GradeBook {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Sasha", 101, undergraduateMarks);
        ...
        GraduateStudent student2 = new GraduateStudent("Claudia", 201, graduateMarks, "Machine Learning in Healthcare");
