...
public class UniversitySystem {
    public static void main(String[] args) {
        Person[] people = {
            new UniversityStudent("Lestat De Lioncourt", 1001, "Computer Science"),
            new Teacher("Dr. Daniel Malloy", 2001, "Data Structures"),
            new Admin("Armand", 3001, "Admissions Office")
        };
