...
public class CoursePortal {
    public static void main(String[] args) {
        LiveCourse liveCourse = new LiveCourse("Java Programming", 40, "Louis", "Mon/Wed 6:00 PM - 8:00 PM");
        RecordedCourse recordedCourse = new RecordedCourse("Web Development Bootcamp", 60, "Armand", 120);
